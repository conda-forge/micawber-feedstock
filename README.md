...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/micawber-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11648&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/micawber-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `micawber` can be installed with:

```
conda install micawber
```

It is possible to list all of the versions of `micawber` available on your platform with:
